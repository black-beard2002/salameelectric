...
const CategoryCard = ({
  ...
  return (
    <div
      onClick={onClick}
      className="relative w-[22%] h-[5.8rem] xs:aspect-square h-fit bg-white dark:bg-zinc-800 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 cursor-pointer group border border-gray-100 dark:border-zinc-700"
    >
      {newFlag && (
